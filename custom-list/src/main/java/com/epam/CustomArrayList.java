...
public class CustomArrayList<T>{
	...
	private static final Logger LOGGER=LogManager.getLogger(CustomArrayList.class);
	
	private Object[] list;
	private int capacity;
	public int index=0;
	
	public CustomArrayList() throws Exception {
		this(10);
	}

	public CustomArrayList(int initCapacity) throws Exception {
		...
		if(capacity>0) 
			...
			throw new Exception("Illegal Capcity: "+capacity);
	}
